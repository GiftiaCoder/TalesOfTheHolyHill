...
public class HolyHillBiome extends Biome {

	protected HolyHillBiome() {
		super((new Biome.BiomeBuilder()).surfaceBuilder(new CompositeSurfaceBuilder<>(NOOP_SURFACE_BUILDER, STONE_STONE_GRAVEL_SURFACE)).
